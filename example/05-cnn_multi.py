        ...
        for i, batch in enumerate(dataloader):
            ...
            if (i % 10) == 0:
                ...
                with torch.no_grad():
                    ...
                    # chunk_temp[valbatch['indices']] = np.sqrt((y - valbatch['rvs'].to('cpu').double())**2).detach().numpy()
                    # chunk_loss  = np.concatenate((chunk_loss,chunk_temp[None,...]),axis=0)
